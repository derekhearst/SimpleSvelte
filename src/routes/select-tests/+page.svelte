...
<div class="container mx-auto max-w-4xl space-y-8 px-4 py-8">
	<div class="space-y-2">
		...
		<p class="text-base-content/70 text-lg">Comprehensive test suite for Select component functionality</p>
	</div>
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		<div>
			...
			<p class="text-base-content/60 text-sm">Basic select with limited options</p>
		</div>
		...
		<div class="bg-base-200 rounded p-3 text-sm">
			...
			<span class="text-base-content/80 ml-2">{smallValue || 'None selected'}</span>
		</div>
	</section>
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		<div>
			...
			<p class="text-base-content/60 text-sm">Select multiple frameworks</p>
		</div>
		<Select
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		<div>
			...
			<p class="text-base-content/60 text-sm">Multi-select with grouped options</p>
		</div>
		<Select
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		<div>
			...
			<p class="text-base-content/60 text-sm">Multi-select with 120 grouped items across 5 groups</p>
		</div>
		<Select
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		...
		<div class="bg-base-200 rounded p-3 text-sm">
			<strong>Selected:</strong>
			<span class="text-base-content/80 ml-2">{autoScrollSingleValue || 'None selected'}</span>
		</div>
	</section>
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		<div>
			...
			<p class="text-base-content/60 text-sm">Select field with required validation</p>
		</div>
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		<div>
			...
			<p class="text-base-content/60 text-sm">Multi-select field (optional)</p>
		</div>
	...
	<section class="bg-base-100 border-base-300 space-y-4 rounded-lg border p-6">
		...
		<div class="bg-base-200 rounded p-3 text-sm">
			<strong>Selected:</strong>
			<span class="text-base-content/80 ml-2">{keyboardSingleValue || 'None selected'}</span>
		</div>
		<Select
		...
		<div class="bg-info/10 text-info-content rounded p-3 text-sm">
			<strong>Instructions:</strong>
			<ul class="text-base-content/80 ml-4 mt-1 list-disc">
	...
	<div class="bg-base-200 border-base-300 flex h-96 items-center justify-center rounded-lg border-2 border-dashed">
		<p class="text-base-content/60">Scroll spacer - position the select above near viewport bottom to test flip behavior</p>
	</div>
</div>
